...
{
    internal sealed class RemoveEmptyPropertyDeclaration : ISuggestedAction
    {
        public RemoveEmptyPropertyDeclaration(SnapshotSpan diagnosticSpan)
        {
        ...
        public string DisplayText
        {
            get
            {
                return $"Remove empty property declaration";
            }
        }
